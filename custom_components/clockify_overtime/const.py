...
CONF_ENABLE_LAST_WEEK_TARGET_SENSOR = "enable_last_week_target_sensor"
CONF_ENABLE_THIS_WEEK_TARGET_SENSOR = "enable_this_week_target_sensor"
...
DEFAULT_ENABLE_LAST_WEEK_TARGET_SENSOR = False
DEFAULT_ENABLE_THIS_WEEK_TARGET_SENSOR = False
